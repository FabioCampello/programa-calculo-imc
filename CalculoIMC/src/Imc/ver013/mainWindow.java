...
public class mainWindow extends JFrame {
	...
	public mainWindow() {
		...
		// -----------------------------------------
		JLabel lblVer = new JLabel("ver 0.1.3");
		...
		// ******************************************************************************************************************************
		// CAMPOS QUE DE EXIBIÇÃO DE MENSAGENS DA APLICAÇÃO
		// ******************************************************************************************************************************
		...
		btnCalcular.setBounds(99, 230, 89, 23);
		...
		btnCalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				// --------------------------------------------------
				// TRECHO DE CONDICIONAIS QUE TRATAM DA POSSIBILIDADE DE CAMPOS VÁZIOS
				// --------------------------------------------------
				if (jtfPeso.getText().equals("") && jtfAltura.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "Insira algum valor no campos!");
				} else if (jtfAltura.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "Insira um valor no campo altura!");
				} else if (jtfPeso.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "Insira um valor no campo peso!");
				}
				...
				//--------------------------------------------------------------
					...
					// -----------------------------------------------------------------------
					// BLOCO CATCH ONDE É CAPTURADO O ERRO, SE HOUVER E INFORMADO AO USUÁRIO.
					// -----------------------------------------------------------------------
					catch (Exception e) {
						// ---------------------------------------------------------------------------
						// DECLARAÇÃO DE UMA VARIÁVEL STRING QUE RECEBE A CAPTURA DA MENSAGEM DE ERRO
						// ---------------------------------------------------------------------------
						String erro = e.getMessage();

						// -------------------------------------------------------------------------------
						// CONDICIONAL QUE COMPARA O ERRO CAPTURADO COM O VALOR ATRIBUÍDO A VARIÁVEL ERRO
						// -------------------------------------------------------------------------------
						if (e.getMessage().equals(erro)) {
							// ----------------------------------------------------------
							// JANELA DE MENSAGEM INFORMANDO AO USUÁRIO O ERRO OCORRIDO.
							// ----------------------------------------------------------
							JOptionPane.showMessageDialog(null, "Use o ponto ao invés da vírgula");
							limparCampo();
